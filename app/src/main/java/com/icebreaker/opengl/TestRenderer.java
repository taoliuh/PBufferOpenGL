...
public class TestRenderer extends GLRenderer {
    ...
    private FloatBuffer getColorVertices() {
        float vertices[] = {1.0f, 0f, 0f, 0.5f};
    ...
    public void onCreated() {
        ...
        mColorVertices = getColorVertices();
...
//            + "void main(){                         \n"
//            + "   gl_Position = vec4(vPosition,0f,1f);\n" // 确定顶点位置
//            + "}";
//
//    // 片元着色器的脚本
